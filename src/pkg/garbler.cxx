...
GarbledLabels GarblerClient::generate_labels(Circuit circuit) {
  ...
  for (auto gate : circuit.gates) {
    ...
    lhs1.value.BytePtr()[0] = first_byte(lhs1.value);
    ...
    rhs1.value.BytePtr()[0] = first_byte(rhs1.value);
